...
- [whalePaper 介绍](#whalepaper-介绍)
  - [目录](#目录)
  - [一、动机](#一动机)
  - [二、whalePaper 存在价值](#二whalepaper-存在价值)
  - [三、whalePaper 分享时间](#三whalepaper-分享时间)
  - [四、whalePaper 分享顺序](#四whalepaper-分享顺序)
  - [五、whalePaper 管理机制](#五whalepaper-管理机制)
  - [六、whalePaper 流出机制](#六whalepaper-流出机制)
  - [七、whalePaper 流入机制](#七whalepaper-流入机制)
  - [八、whalePaper 构思](#八whalepaper-构思)
  - [九、whalePaper 必须分享内容](#九whalepaper-必须分享内容)
  - [十、whalePaper 分享论文管理](#十whalepaper-分享论文管理)
    - [Topic 5](#topic-5)
      - [>> 自然语言处理](#blockquoteblockquote自然语言处理blockquoteblockquote)
      - [>> 图像处理](#blockquoteblockquote图像处理blockquoteblockquote)
      - [>> 推荐系统](#blockquoteblockquote推荐系统blockquoteblockquote)
    - [Topic 4](#topic-4)
      - [>> 自然语言处理](#blockquoteblockquote自然语言处理blockquoteblockquote-1)
      - [>> 图像处理](#blockquoteblockquote图像处理blockquoteblockquote-1)
      - [>> 推荐系统](#blockquoteblockquote推荐系统blockquoteblockquote-1)
    - [Topic 3](#topic-3)
      - [>> 自然语言处理](#blockquoteblockquote自然语言处理blockquoteblockquote-2)
      - [>> 图像处理](#blockquoteblockquote图像处理blockquoteblockquote-2)
    - [Topic 2](#topic-2)
      - [>> 自然语言处理 之 基于细粒度情感分析](#blockquoteblockquote自然语言处理-之-基于细粒度情感分析blockquoteblockquote)
    - [Topic 1](#topic-1)
      - [>> 自然语言处理 之 文本匹配](#blockquoteblockquote自然语言处理-之-文本匹配blockquoteblockquote)
      - [>> 图像处理 之 人脸识别](#blockquoteblockquote图像处理-之-人脸识别blockquoteblockquote)
    - [初期](#初期)
      - [>> 自然语言处理](#blockquoteblockquote自然语言处理blockquoteblockquote-3)
      - [>> 图像处理](#blockquoteblockquote图像处理blockquoteblockquote-3)

## 一、动机

1. 你是否也再一个人干巴巴的读论文?
2. 你是否在论文过程中，特别想找人分享自己的见解？
...
每个人选择自己感兴趣的论文，确定每一篇论文的分享时间，每一个组织成员需要记住分享时间，避免忘记分享；（**PS：如果觉得自己因为工作或者其他原因没时间，那么我觉得没必要参与进来，因为这种方式对于你来说进步并不大，而且还会浪费过多的时间和精力**）
...
1. 负责 新成员 的加入 考核；
2. 负责 whalePaper 学习群 的 通知 和 管理；
3. 负责 whalePaper 学习群 的优化工作；
...
我会建立一个 whalePaper 准学习群，然后 每一个 想加入的成员会先加入该群，然后 需要准备一篇论文向 审核组 进行分享，审核组 会根据论文内容进行提问，最后由投票确定是否晋升 内部群。

## 八、whalePaper 构思

梯度 方式（建立 一个 分享群，所有人都可以加入，每周定期有人分享，比较优秀的人可以加入 whalePaper 学习群）
...
Classification](Topic2/NLP/4-LCF.pdf)【杨夕】

### Topic 1

#### >> 自然语言处理 之 文本匹配

1. [Lattice CNNs for Matching Based Chinese Question Answering](Topic1/NLP/3-LCNQA.pdf)【杨夕】
2. [自然语言处理（Natural Language Processing，NLP）](Topic1/NLP/NLP介绍.pdf)【杨夕】
3. [Multi-Perspective Sentence Similarity Modeling with Convolutional Neural Networks](Topic1/NLP/MPCNN.pdf)【黑桃】
4. [Simple and Effective Text Matching with Richer Alignment Features](Topic1/NLP/深度学习分享之文本匹配.pdf)【李文乐】

#### >> 图像处理 之 人脸识别

1. [Dual attention network for Scene Segmentation](Topic1/CV/DANet.pdf)【杨夕】
2. [EfficientNet : Rethinking Model Scaling for Convolutional Neural Networks](Topic1/CV/efficientnet.pdf)【蘇靜】
3. [Accelerating Proposal Generation Network for Fast Face Detection on Mobile Devices](Topic1/CV/faceDetection.pdf)【以若】

### 初期

#### >> 自然语言处理

1. [Attention is all you need](old/NLP/attention_is_all_you_need.pdf)【李方】
2. [关系抽取 综述](old/NLP/关系抽取review.pdf)【杨夕】
3. [命名实体识别 综述](old/NLP/命名实体识别review.pdf)【杨夕】
4. [Multi-grained Attention Network for AspectLevel Sentiment Classification](old/NLP/ABSA.pdf)【李文乐】
5. [Transformer及其变体](old/NLP/Transformer及其变体.pdf)【Jepson】

#### >> 图像处理

1. [RetinaFace: Single-stage Dense Face Localisation in the Wild](old/CV/RetinaFace.pdf)【蘇靜】
